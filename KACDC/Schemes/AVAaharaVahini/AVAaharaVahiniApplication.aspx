<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AVAaharaVahiniApplication.aspx.cs" Inherits="KACDC.Schemes.AVAaharaVahini.AVAaharaVahiniApplication" MaintainScrollPositionOnPostback="true" %>
                    ...
                    <div class="NeumorphicDiv">
                        <div class="form-row">
                            <div class="form-row-label-Heading" style=" border-radius: 15px;">
                                <asp:Label ID="Label5" class="" runat="server" Text="Aahara Vahini loan application"></asp:Label>
                            </div>
                        </div>
                        <%--Aadhaar Number--%>
                        <div class="form-row">
                        ...
                        <%--timer--%>
                        <div id="timerGuidelines" class="form-row" runat="server" visible="false">
                        <button id="js-startTimer">Next</button>
                        <p>Read the Guidelines Below Carefully for <span class="js-timeout">2:00</span>.</p>
