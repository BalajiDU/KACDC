...
namespace KACDC.Class.Declaration.Nadakacheri
{
    public class NadakacheriPWD
    {
        ...
        public string RIReportNo
        {
            set { HttpContext.Current.Session["RIReportNo"] = value; }
            get { return HttpContext.Current.Session["RIReportNo"] as string; }
        }
        public string AppDisability
        {
